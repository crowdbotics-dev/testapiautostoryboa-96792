...
## Project Structure
    ...
    ├── testapiautostoryboa_96792  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_96792`
...
2. Clone this repo and `cd testapiautostoryboa_96792`
